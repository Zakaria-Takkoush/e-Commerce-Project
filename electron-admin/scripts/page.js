...
.then(function (response) {
    ...
    for (let i = 0; i < categories.length; i++) {
        ...
        cat_row += `
            ...
            <td>${id}</td>
            <td>${name}</td>
            <td><a href="#" onClick="editCategory(${id})" id="edit-category-btn"><i class="fa-regular fa-pen-to-square"></i> Edit </a></td>
...
function editCategory(category_id) {
    ...
    // show pop-up edit category window
    edit_category_popup.style.display = "block";
    ...
    // add a click event to the submit edit button
    edit_category.addEventListener("click", function (event) {
